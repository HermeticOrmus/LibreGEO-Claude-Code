# Per-Platform Optimization Reference

Loaded by `SKILL.md`. Each section is one platform: how it selects sources, the 10-item optimization checklist, the 0-100 scoring rubric.
